  ...
  return (
    <Wrapper>
      <Header>
        <Logo big />
        <p>
          Resume Builder is a tool for automatically generating beautiful resumes.
        </p>
        <p>
          The webapp was made by{' '}
          <Link href="https://www.higheredd.com/">Higheredd</Link> and was built with
      ...
      <Content>
        <section>
          ...
          <Answer>
            Definitely! We're always happy to help out first-time contributors to
            the project. You can to us at{' '}
            <Link href="mailto:team@higheredd.com"></Link>
          </Answer>
